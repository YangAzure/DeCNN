#!/bin/bash
source /home/sensorweb/tensorflow/bin/activate tensorflow
export ServiceHOME=/home/sensorweb/Dropbox/DeCNN
homefolder="$(pwd)"
...
stdbuf -oL nohup $ServiceHOME/alexnetDec.py  >> $ServiceHOME/alexnet$nodeid.log
